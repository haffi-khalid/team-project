...
public class CharityProfile implements Serializable {
    ...
    @OneToOne(mappedBy = "charityProfile")
    ...
    public void setCharityAdmin(CharityAdmin charityAdmin) {
        if (this.charityAdmin != null) {
            this.charityAdmin.setCharityProfile(null);
        }
        if (charityAdmin != null) {
            charityAdmin.setCharityProfile(this);
        }
        this.charityAdmin = charityAdmin;
    }

    public CharityProfile charityAdmin(CharityAdmin charityAdmin) {
