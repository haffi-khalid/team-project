...
describe('CharityAdmin Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call charityProfile query and add missing value', () => {
      ...
      const expectedCollection: ICharityProfile[] = [charityProfile, ...charityProfileCollection];
      ...
      expect(charityProfileService.addCharityProfileToCollectionIfMissing).toHaveBeenCalledWith(charityProfileCollection, charityProfile);
      expect(comp.charityProfilesCollection).toEqual(expectedCollection);
    });
    ...
    it('Should update editForm', () => {
      ...
      expect(comp.charityProfilesCollection).toContain(charityProfile);
