...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().userName(DEFAULT_USER_NAME).role(DEFAULT_ROLE);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().userName(UPDATED_USER_NAME).role(UPDATED_ROLE);
        return userProfile;
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.userName(UPDATED_USER_NAME).role(UPDATED_ROLE);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.role(UPDATED_ROLE);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.userName(UPDATED_USER_NAME).role(UPDATED_ROLE);
