...
class SocialFeedResourceIT {
    ...
    public static SocialFeed createEntity(EntityManager em) {
        SocialFeed socialFeed = new SocialFeed().lastUpdated(DEFAULT_LAST_UPDATED);
        return socialFeed;
    }
    ...
    public static SocialFeed createUpdatedEntity(EntityManager em) {
        SocialFeed socialFeed = new SocialFeed().lastUpdated(UPDATED_LAST_UPDATED);
        return socialFeed;
    }
    ...
    void putExistingSocialFeed() throws Exception {
        ...
        updatedSocialFeed.lastUpdated(UPDATED_LAST_UPDATED);
    ...
    void partialUpdateSocialFeedWithPatch() throws Exception {
        ...
        partialUpdatedSocialFeed.lastUpdated(UPDATED_LAST_UPDATED);
