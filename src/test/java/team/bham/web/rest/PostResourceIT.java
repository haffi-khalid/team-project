...
class PostResourceIT {
    ...
    private static final Integer DEFAULT_SHARES = 1;
    private static final Integer UPDATED_SHARES = 2;
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().content(DEFAULT_CONTENT).timestamp(DEFAULT_TIMESTAMP).likes(DEFAULT_LIKES).shares(DEFAULT_SHARES);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().content(UPDATED_CONTENT).timestamp(UPDATED_TIMESTAMP).likes(UPDATED_LIKES).shares(UPDATED_SHARES);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getShares()).isEqualTo(DEFAULT_SHARES);
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.content(UPDATED_CONTENT).timestamp(UPDATED_TIMESTAMP).likes(UPDATED_LIKES).shares(UPDATED_SHARES);
        ...
        assertThat(testPost.getShares()).isEqualTo(UPDATED_SHARES);
    }
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.shares(UPDATED_SHARES);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.content(UPDATED_CONTENT).timestamp(UPDATED_TIMESTAMP).likes(UPDATED_LIKES).shares(UPDATED_SHARES);
