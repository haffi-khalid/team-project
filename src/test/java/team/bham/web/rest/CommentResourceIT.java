...
class CommentResourceIT {
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.parentID(UPDATED_PARENT_ID).content(UPDATED_CONTENT).timeStamp(UPDATED_TIME_STAMP).status(UPDATED_STATUS);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.parentID(UPDATED_PARENT_ID).timeStamp(UPDATED_TIME_STAMP).status(UPDATED_STATUS);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.parentID(UPDATED_PARENT_ID).content(UPDATED_CONTENT).timeStamp(UPDATED_TIME_STAMP).status(UPDATED_STATUS);
